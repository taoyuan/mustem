...
function isRenderable(value, context) {
  if (value === context.view && _.isObject(context.view) && _.isFunction(context.view.text)) {
    return false;
  }
...
Renderer.prototype.renderSection = function renderSection(token, context, partials, originalTemplate) {
  ...
  if (_.isArray(value)) {
    ...
    return P.resolve(value).then(function (value) {
      if (isRenderable(value, context)) context.render(value);
      return value;
    })
